...
export function getStandardVariableCompletions(type) {
    var completions = [];
    for (var variable in definedVariables) {
...
export function getVariableCompletions(ctx) {
...
export function getCurrentVariableCompletions(ctx, position) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (ctx.prevToken instanceof Symbols.Variable
                && position.column - 1 === ctx.prevToken.endColumn) {
                return [2 /*return*/, getStandardVariableCompletions(ctx.isInCondition ? ctx.fieldType : null).map(function (s) {
                        return {
                            label: s.label,
                            kind: monaco.languages.CompletionItemKind.Variable,
