...
var SyntaxErrorChecker = /** @class */ (function () {
    function SyntaxErrorChecker() {
    }
    SyntaxErrorChecker.prototype.check = function (parseResult) {
        return __awaiter(this, void 0, void 0, function () {
            var errorToken, hoverMessage, decoration;
            return __generator(this, function (_a) {
                ...
                decoration = decorationFromSym(hoverMessage, errorToken);
                decoration.range = decoration.range.setEndPosition(Infinity, Infinity);
                return [2 /*return*/, [decoration]];
            });
        });
    };
    return SyntaxErrorChecker;
}());
export { SyntaxErrorChecker };
//# sourceMappingURL=SyntaxErrorChecker.js.map