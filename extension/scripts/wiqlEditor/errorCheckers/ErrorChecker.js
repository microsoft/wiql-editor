...
var ErrorChecker = /** @class */ (function () {
    ...
    ErrorChecker.prototype.check = function (parseResult) {
        return __awaiter(this, void 0, void 0, function () {
            var promises, allErrorArrs, allErrors, _i, allErrorArrs_1, errors;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        promises = this.errorCheckers.map(function (checker) { return checker.check(parseResult); });
                        return [4 /*yield*/, Promise.all(promises)];
                    case 1:
                        allErrorArrs = _a.sent();
                        allErrors = [];
                        for (_i = 0, allErrorArrs_1 = allErrorArrs; _i < allErrorArrs_1.length; _i++) {
                            errors = allErrorArrs_1[_i];
...
export { ErrorChecker };
//# sourceMappingURL=ErrorChecker.js.map