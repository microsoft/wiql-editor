...
function hardGetTeams(projName) {
    return __awaiter(this, void 0, void 0, function () {
        var teams, skip, batch;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    teams = [];
                ...
                case 1:
                    ...
                    return [4 /*yield*/, getTeamsRest(projName, 100, skip)];
                case 2:
                    batch = _a.sent();
                    teams.push.apply(teams, batch);
                    skip += 100;
                    if (batch.length < 100) {
...
var teamsMap = {};
export function getTeams(projName) {
